...
| **Infraestructura** | Detalles técnicos | EF Core, SQL Server / Azure SQL, IA con Gemini, Hangfire |
...
| **Azure Container Apps** | N/A (IA movida a C# nativo con Gemini)| N/A |
...
3. Ticket creado → TicketCreadoEvent
   ↓
4. Backend encola trabajo de sanitización (o procesa directo)
   ↓
...
### Fase 2 ✅ COMPLETADA
- [x] Infrastructure: EF Core DbContext & Migrations
- [x] Infrastructure: Repositories & Specifications Pattern
- [x] Application: DTOs & FluentValidation
- [x] Application: MediatR Commands/Queries/Handlers
- [x] Application: AutoMapper Profiles
- [x] Application: Domain Event Handlers
- [x] Application: Dependency Injection Configuration
...
- [x] Sanitización y Clasificación con IA (Gemini)
- [x] External Service Adapters (IA, Email, Notificaciones)
...
**📖 Para detalles completos consulta [ROADMAP_FUTURO.md](./docs/ROADMAP_FUTURO.md)** - Incluye:
