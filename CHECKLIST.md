...
- [x] **Pendiente**: Reemplazar la autenticación Mock (mock auth con el email `admin@empresa.com`) por la integración real de JWT Token e Identity completa entre Blazor y la API.
