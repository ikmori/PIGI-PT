...
- [x] Reemplazar la autenticación Mock (mock auth con el email `admin@empresa.com`) por la integración real de JWT Token e Identity completa entre Blazor y la API.
...
- [x] Integrar **Hangfire** para ejecutar procesos en segundo plano (e.g., re-verificación de riesgos, limpiezas).
...
- [x] Integración de notificaciones por Email (SendGrid / SMTP) tras la creación y asignación de tickets.
